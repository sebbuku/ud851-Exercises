...
public class MainActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<String>{
    ...
    private static final int GITHUB_SEARCH_LOADER = 937;
    ...
    private void makeGithubSearchQuery() {
        ...
        if (githubQuery == "") {
            Toast.makeText(this, "Nothing to search. Aborting!", Toast.LENGTH_SHORT).show();
        ...
        Loader<String> stringLoader = loaderManager.getLoader(GITHUB_SEARCH_LOADER);
    ...
    public Loader<String> onCreateLoader(int i, final Bundle bundle) {
        ...
        return new AsyncTaskLoader<String>(this) {
            ...
            public String loadInBackground() {
                ...
                URL githubUrl = NetworkUtils.buildUrl(queryUrl);
                try {
