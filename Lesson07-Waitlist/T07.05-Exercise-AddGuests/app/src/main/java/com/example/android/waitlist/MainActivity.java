...
public class MainActivity extends AppCompatActivity {
    ...
    public void addToWaitlist(View view) {
        ...
        try {
            partySize = Integer.parseInt(partySizeAsString);
        }
        catch (NumberFormatException exception) {
            Log.d(
                    LOG_TAG,
                    "Could not convert to party size edit text to int." + exception.getMessage()
            );
            return;
        }
    ...
    private void addNewGuest(String newGuestName, int partySize) {
