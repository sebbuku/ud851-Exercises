...
public class NotificationUtils {
    private static final int WATER_REMINDER_PENDING_INTENT_ID = 650;
    private static final String WATER_REMINDER_NOTIFICATION_CHANNEL = "water-reminder";
    private static final int WATER_REMINDER_NOTIFICATION_ID = 297;
    ...
    public static void remindUserBecauseCharging(Context context) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            NotificationChannel notificationChannel = new NotificationChannel(
                    WATER_REMINDER_NOTIFICATION_CHANNEL,
        ...
        NotificationCompat.Builder builder = new NotificationCompat.Builder(context, WATER_REMINDER_NOTIFICATION_CHANNEL);
