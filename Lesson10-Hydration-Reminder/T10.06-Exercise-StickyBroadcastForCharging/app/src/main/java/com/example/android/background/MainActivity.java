...
public class MainActivity extends AppCompatActivity implements
    ...
    protected void onResume() {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            ...
            Intent batteryChargingIntent = registerReceiver(null, intentFilter);
            ...
            int chargingStatusExtra = batteryChargingIntent.getIntExtra(BatteryManager.EXTRA_STATUS, BatteryManager.BATTERY_STATUS_UNKNOWN);
            isCharging = chargingStatusExtra == BatteryManager.BATTERY_STATUS_CHARGING || chargingStatusExtra == BatteryManager.BATTERY_STATUS_FULL;
